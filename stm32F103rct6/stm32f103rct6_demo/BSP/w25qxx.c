...
u16 W25QXX_TYPE=W25Q16;	//默认是W25Q256
...
{ 
    ...
    */
    ...
    if(W25QXX_TYPE==W25Q256)                //SPI FLASH为W25Q256
    {
		...
		{
			W25QxEnable();//W25QXX_CS=0; 			        //选中
			SPI5_ReadWriteByte(W25X_Enable4ByteAddr);//发送进入4字节地址模式指令   
			W25QxDisable();//W25QXX_CS=1;       		        //取消片选   
		}
    }
}  
...
{  
	...
	W25QxDisable();//W25QXX_CS=1;;                                //取消片选     	      
    HAL_Delay(3);//delay_us(3);                                //等待TRES1
}   
